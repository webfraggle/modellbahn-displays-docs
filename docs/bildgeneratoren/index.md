...
Die Bildgeneratoren sind kleine Online-Dienste, die fertige Bilder genau im Format deines Displays erzeugen — zum Beispiel eine Wettervorhersage oder einen aktuellen Börsenkurs. Dein Display ruft so ein Bild einfach über eine Internet-Adresse (URL) ab und zeigt es an.
